            ...
            <div className="mt-4 text-center">
              ...
              <div className="mt-6 flex space-x-3">
                ...
                <button
                  ...
                  className="flex-1 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-md text-sm font-medium transition-colors"
                >
                  Report Error
                </button>
              </div>
