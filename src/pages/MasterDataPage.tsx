...
const MasterDataPage: React.FC = () => {
  ...
  const renderModalContent = () => {
        ...
        return (
            <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="inventory-name" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">Name</label>
                        <input 
                            id="inventory-name"
                            name="name" 
                    ...
                    <div>
                        <label htmlFor="inventory-sku" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">SKU</label>
                        <input 
                            id="inventory-sku"
                            name="sku" 
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="inventory-category" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">Category</label>
                        <input 
                    ...
                    <div>
                        <label htmlFor="inventory-location" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">Location</label>
                        <input 
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="inventory-costPrice" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">Cost Price</label>
                        <input 
                    ...
                    <div>
                        <label htmlFor="inventory-reorderPoint" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">Reorder Point</label>
                        <input 
                 ...
                 <div>
                    <label htmlFor="inventory-isSerialized" className="flex items-center">
                        <input 
                            id="inventory-isSerialized"
                            type="checkbox" 
                            name="isSerialized" 
                            checked={editingItem.isSerialized || false} 
                            onChange={handleInputChange} 
                            className="h-4 w-4 rounded" 
                        />
                        <span className="ml-2">Is Serialized</span>
                    </label>
                </div>
            </div>
        );
    ...
    if (activeTab === 'vendors') {
        return (
             <div className="space-y-4">
                <div>
                    <label htmlFor="vendor-name" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">Name</label>
                    <input 
                        id="vendor-name"
                        name="name" 
                        value={editingItem.name || ''} 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="vendor-contactPerson" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">Contact Person</label>
                        <input 
                    ...
                    <div>
                        <label htmlFor="vendor-email" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">Email</label>
                        <input 
                            id="vendor-email"
                            type="email" 
                            name="email" 
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="vendor-phone" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">Phone</label>
                        <input 
                            id="vendor-phone"
                            type="tel" 
                            name="phone" 
                    ...
                    <div>
                        <label htmlFor="vendor-lastCommunicationDate" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">Last Communication</label>
                        <input 
                            id="vendor-lastCommunicationDate"
                            type="date" 
                            name="lastCommunicationDate" 
                            value={editingItem.lastCommunicationDate || ''} 
                            onChange={handleInputChange} 
                            className={`mt-1 w-full ${TAILWIND_INPUT_CLASSES}`} 
                            autoComplete="off"
                        />
                ...
                <div>
                    <label htmlFor="vendor-performanceScore" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">Performance Score (0-100)</label>
                    <input 
                        id="vendor-performanceScore"
                        type="number" 
                        name="performanceScore" 
                        value={editingItem.performanceScore ?? ''} 
                        onChange={handleInputChange} 
                        className={`mt-1 w-full ${TAILWIND_INPUT_CLASSES}`} 
                        min="0" 
                        max="100" 
                ...
                <div>
                    <label htmlFor="vendor-products" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">Products (comma-separated)</label>
                    <input 
                        id="vendor-products"
                        name="products" 
                        value={Array.isArray(editingItem.products) ? editingItem.products.join(', ') : ''} 
                        onChange={handleInputChange} 
                        className={`mt-1 w-full ${TAILWIND_INPUT_CLASSES}`} 
                        autoComplete="off"
                    />
  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        <label htmlFor="search-master-data" className="sr-only">Search {activeTab}</label>
        <input 
          id="search-master-data"
          type="text" 
          placeholder={`Search ${activeTab}...`} 
          value={searchTerm} 
          onChange={(e) => setSearchTerm(e.target.value)}
          className={`block w-full pl-4 pr-3 py-2 ${TAILWIND_INPUT_CLASSES}`} 
