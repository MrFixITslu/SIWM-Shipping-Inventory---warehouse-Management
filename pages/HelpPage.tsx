  ...
  return (
    <PageContainer title="Vision79 SIWM - User Guide">
      <div className="prose dark:prose-invert max-w-none">
        ...
        <ol className={listClass}>
            <li>In the shipment's detail view, once payment is confirmed, click the <strong className={stepClass}>"Receive Shipment"</strong> button.</li>
            ...
            <li>Once all items are counted, click <strong className={stepClass}>"Complete Receiving"</strong>.</li>
            <li>The system will automatically update inventory levels. If there are any discrepancies between expected and received amounts, the shipment status will be set to <code className={codeBlockClass}>Processing</code> and a notification will be generated for a manager to review. If everything matches, the status will be set to <code className={codeBlockClass}>Arrived</code>.</li>
        </ol>
