...
const LogisticsOptimizationPage = React.lazy(() => import('@/pages/LogisticsOptimizationPage'));
...
// This is a constant mapping, so it can be defined once outside the component.
const routePermissions = ALL_NAV_ITEMS.reduce((acc, item) => {
        ...
        <Suspense fallback={<PageLoadingFallback />}>
          <Routes>
            ...
            >
              ...
              <Route path="logistics-optimization" element={<LogisticsOptimizationPage />} />
